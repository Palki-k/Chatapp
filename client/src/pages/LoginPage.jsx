  ...
  const onSubmitHandler = (event) =>{
    ...
    <h2 className='font-medium text-2xl flex justify-between items-center'>
      ...
      {currState === "sign up" && !isDataSubmitted && ( 
        ...
        type="text" className='p-2 border border-gray-500 rounded-md focus:outline-none bg-transparent'
      ...
      {currState === "sign up" && isDataSubmitted && (
          ...
          rows={4} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2
           focus:ring-indigo-500 bg-transparent' placeholder='provide a short bio...' required>
